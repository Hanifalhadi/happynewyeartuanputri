...
const letters = "I LOVE YOU ZULFA";
let letterIndex = 0;
...
// Tambahkan audio dengan listener pada klik pengguna
const audio = document.createElement('audio');
audio.controls = false;
audio.loop = true;
audio.src = 'tumblr.mp3'; // Replace 'tumblr.mp3' dengan path file Anda
audio.volume = 1;

document.body.appendChild(audio);

// Pastikan audio diputar saat pengguna mengklik halaman
